...
////////////////////////////// Here we go! //////////////////////////////////////////
	...
	const String error (mAudioDeviceManager.initialise (CGestalt::numInChannels(),	/* stereo input */
...
void CSLAbstComponent::audioDeviceAboutToStart (AudioIODevice* device) {
...
void CSLSignalComponent::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
...
void CSLSignalComponent::sliderValueChanged (Slider* sliderThatWasMoved)
{
