...
public:
	...
	// ~~~~~~~~~ 3D ~~~~~~~~~~~~~~
	CPoint(int a, int b, int c) { dimn = 3; x = a; y = b; z = c;  }
...
//	CPoint(CPoint & other);		// Copy constructor -- use '=' instead
	...
	// ~~~~~~~~~ Accessors ~~~~~~~~~~~~~~
	void set(int a, int b) { dimn = 2; x = a; y = b; z = 0;  }
	void set(int a, int b, int c) { dimn = 3; x = a; y = b; z = c;  }
