...
testStruct panTestList[] = {
	"Stereo panner",			testPan,
//	"N2M panner",				testN2MPan,
	"Mixer",					testSineMixer,
	"Panning mixer",			testPanMix,
	"Bigger panning mixer",		testBigPanMix,
#ifdef USE_CONVOLVER
	"Test convolver",			testConvolver,
	"Test convolver 2",			testConvolver2,
	"Test convolver 3",			testConvolver3,
#endif
	"Osc bank",					testOscBank,
//	"-CMap IO",					testCMapIO,
	"HRTF horiz circles",		test_Binaural_horiz,
	"HRTF axial circles",		test_Binaural_vertAxial,
	"HRTF median circles",		test_Binaural_vertMedian,
	"Ambisonics",				test_Ambi_horiz,
//	"VBAP",						test_VBAP_horiz,
	NULL,						NULL
};
