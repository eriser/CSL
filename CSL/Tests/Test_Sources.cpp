...
testStruct srcTestList[] = {
	"Noise tests",				testNoises,
	"Plucked string",			testString,
	"String chorus",			testStringChorus,
	"Mono Snd file player",		testMonoSoundFilePlayer,
	"Stereo Snd file player",	testStereoSoundFilePlayer,
#ifdef USE_MP3
	"MP3 Snd file player",		testMP3FilePlayer,
#endif
	"Snd file transpose",		testSoundFileTranspose,
	"Snd file bank",			testSndFileBank,
	"FM instrument",			testFMInstrument,
	"Fancy FM instrument",		testFancyFMInstrument,
	"SumOfSines instrument",	testSOSInstrument,
	"Snd file instrument",		testSndFileInstrument,
	"IFFT synthesis",			test_ifft,
	"Vector IFFT",				test_vector_ifft,
	"Soundfile granulation",	testGrainCloud,
	NULL,						NULL
};
