...
testStruct envTestList[] = {
	"Glissando",			testGliss,
	"Swell",				testSwell,
	"Rand Freq envelope",	testFrequencyEnv,
	"50 Rand Freq/Ampl envelopes",test50RandFreqEnv,
	"AR sine",				testARSin,
//	"AR sine 2",			testARSin2,
	"AM/FM envelopes",		testAMFMEnvs,
	"ADSR 2",				testADSR2,
	"ADSR FM",				testADSR_FM,
	"Rand Freq envelope",	testRandFreqEnv,
//	"Envelope scaling",		testEnvScale,
	"Fancy FM",				testFancy_FM,
	"Complex envelope",		testComplexEnvelope,
	"Many random SumOfSines",	testManyRandSOS,
	NULL,					NULL
};
