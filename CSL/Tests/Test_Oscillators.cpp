...
testStruct oscTestList[] = {
	"Sweep test",				testSweep,
	"Simple sines",				testSimpleSines,
	"Standard waveforms",		testBasicWaves,
	"Scaled sine",				testScaledSin,
	"Wavetable interpolation",	testWavetableInterpolation,
	"AM/FM sines",				testAMFMSin,
	"Dump AM/FM sines",			dumpAMFMSin,
	"SumOfSines cached",		testSumOfSinesCached,
	"SumOfSines non-cached",	testSumOfSinesNonCached,
	"SumOfSines build",			testSumOfSinesSteps,
	"SumOfSines 1/f",			testSumOfSines1F,
	"Wavetable from file",		testWaveTableFromFile,
	"SHARC SOS",				test_SHARC,
	"Vector SHARC",				test_SHARC2,
	NULL,						NULL
};
