...
///		SumOfSines vox(1, 5,  0.2, 0.2, 0.1, 0.1, 0.05)						-- first 5 overtones with weights 0.2, 0.2...
///
///	Format kFreqAmp = list of values for overtone freq/amplitudes with phases = 0
///		SumOfSines vox(2, 3,  1, 0.2,   2, 0.1,   3.01, 0.05)					-- overtones 1, 2, and 3.01 (i.e., non-harmonic)
///
///	Format kFreqAmpPhase = list of values for overtone num/amps/phases
///		SumOfSines vox(3, 3  1.02, 0.2, 0,   2.1, 0.2, 0.1,   3.0, 0.1, 0.05)		-- verbose constructor
///
